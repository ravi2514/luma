...
public class Locators {
	...
	// Drivers details	
			...
			/****************************************            WARRANT REPLACEMENT                  ***********************************************/
				...
				public String fndStore= "button.btn.btn-lg.btn-outline-black.mt-10";
				...
				public String upgrade = "Want to upgrade your replacement?";
				...
				public String shipCodeChk="#block-discount-heading > label > input";                    //"div.payment-option-title.field.choice > input[type='checkbox']";
